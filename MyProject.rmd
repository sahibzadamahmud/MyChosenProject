---
title: "Using Clustering to Establish Patterns in Heart Disease Patients"
author: "Ali Mahmud"
date: "June 10, 2019"
output:
...
# Checking how does the data look like in summarized form now
summary(scaled)
```
...
<<<<<<< HEAD
# Checking how many patients are in each group
=======
# How many patients are in each group?
>>>>>>> e5b166296a26747938ea6bc3fe4d1d091f41e6ef
first_clust$size
```
...
<<<<<<< HEAD
# Checking How many patients are in each group Now for comparison
=======
# How many patients are in each group?
>>>>>>> e5b166296a26747938ea6bc3fe4d1d091f41e6ef
second_clust$size
